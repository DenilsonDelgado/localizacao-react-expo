...
- **Node.js**: Certifique-se de ter o Node.js instalado na sua máquina. [Baixe o Node.js](https://nodejs.org/).

- **Expo CLI**: Ferramenta de linha de comando para iniciar e gerenciar projetos Expo. Se você não tem o Expo CLI instalado, instale com o comando:
  ```bash
